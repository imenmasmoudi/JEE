    ...
    <body>
        ...
        <form action="SeanceController" method="POST">
            <table>
                ...
                <tr><td>ID :</td></tr>
                <tr><td><input type="number" name="id" value="<%= a.getId_seance()%>" readonly="true"></td></tr>
                <tr><td>Date :</td></tr>
                <tr><td><input type="date" name="date" value="<%= date%>"></td></tr>
                <tr><td>Heure Debut :</td></tr>
                <tr><td><input type="time" name="h_debut" value="<%= heure%>"></td></tr>
                <tr><td>Durée :</td></tr>
                ...
                <tr><td>Validité :</td></tr>
                <tr><td>Valid : <input type="radio" name="valide" value="1" checked="<%= a.isValide()%>">
                        Non Valid : <input type="radio" name="valide" value="0" checked="<%= a.isValide()%>" >
                    </td><tr>
                <tr><td>Type :</td></tr>      
                <tr>
                    <td><select name="type">
