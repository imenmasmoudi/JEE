...
<html>
  ...
  <div class="col-4">  
       <div class="card">
  <div class="card-body">
     <h3>Modifier Niveau</h3>
                <form action="NiveauController" method="POST">
  <%
                Niveau a = (Niveau)request.getAttribute("niveau");
            %>
             <input type="hidden" name="action" value="upgrade"/>
  <div class="row mb-4">
    <div class="col">
      <div class="form-outline">
        <input type="number" name="id" value="<%=a.getId() %>" readonly="true" class="form-control" />
  ...
  <!-- Submit button -->
  <input type="submit" value="Modifier le niveau" name="OK" class="btn btn-primary btn-block mb-4">
</form>
  </div>
</div></div>
  <div class="col-4"></div>
