...
<html>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse row justify-content-between" id="navbarNav"> 
                ...
                <div class="col-9">
                  <ul class="navbar-nav ">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="./DepartementController?action=getAll">liste des Departements</a>
                      </li>
                      <li class="nav-item">
        ...
        <h1 class="text-center mt-5">liste des Departements</h1>
        ...
        <div class="row  px-5 my-3" >
            ...
            <div class="col-3  " >
                <a href="./ajouterDepartement.jsp" style="float:right" class="btn btn-success " > Ajouter </a>
            </div>
  ...
  <tbody>
     <%
                List<Departement> list = (List<Departement>) request.getAttribute("listedepartement");
                ...
                for (Departement a : list) {
                    Enseignant e = ed.getEnseignantByID(a.getId_enseignant());
                    i++;
