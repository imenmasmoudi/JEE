<%-- 
    Document   : listegrade
    Created on : 20 juin 2021, 21:21:06
    Author     : Amine
--%>
...
<html>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse row justify-content-between" id="navbarNav"> 
                ...
                <div class="col-9">
                  <ul class="navbar-nav ">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="./SeanceController?action=getAll">liste des Seances</a>
                      </li>
                  </ul>
                </div>
        ...
        <h1 class="text-center mt-5">liste des Seances</h1>
        ...
        <div class="row  px-5 my-3" >
            ...
            <div class="col-3  " >
                <a href="./ajouterSeance.jsp" style="float:right" class="btn btn-success " > Ajouter </a>
            </div>
  ...
  <tbody>
     <%
                ...
                List<Seance> list = (List<Seance>) request.getAttribute("listeseance");
                ...
                for (Seance a : list) {
                    ...
                    out.print("<tr><td>" + i + "</td><td>" + date + "</td><td>" + heure + "</td><td>" + a.getDuree() + "</td><td>" + a.getMethode() + "</td><td>" + a.isValide() + "</td><td>" + a.getType() + "</td><td>" + m.getLibelle() + " </td><td> " + e.getPrenom() + " " + e.getNom() + "</td><td><a class='btn btn-danger mx-1' href=\"./SeanceController?action=remove&id=" + a.getId_seance() + "\">Supprimer</a><a class='btn btn-primary mx-1' href=\"./SeanceController?action=edit&id=" + a.getId_seance() + "\">Modifier</a></td></tr>");
